...
https://github.com/bob798/openvino-model-lab
...
```bash
git clone https://github.com/bob798/openvino-model-lab
cd openvino-model-lab
python -m venv venv && source venv/bin/activate     # or .\venv\Scripts\activate on Windows
pip install torch==2.11.0 transformers==4.57.6 openvino==2026.1.0 optimum-intel==1.27.0 nncf
python deepseek-v4/tests/test_modeling_smoke.py
python deepseek-v4/scripts/convert_to_openvino.py
python deepseek-v4/scripts/quantize_with_nncf.py
python deepseek-v4/scripts/export_to_optimum_intel.py
python deepseek-v4/tests/test_dequant.py
python deepseek-v4/scripts/load_real_v4_weights.py --dry-run
```
...
The PoC repo is the same: https://github.com/bob798/openvino-model-lab
